...
/*
function toggleUndo() {
	undoButton = document.getElementById("pac-button-undo");
	if (undoButton.
*/
...
function finishPath() {
	//TODO: Disable undo button and change its color
	document.getElementById("pac-button-undo").style.backgroundColor = "blue";
